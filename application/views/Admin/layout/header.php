      ...
      <header class="topnavbar-wrapper">
         ...
         <nav class="navbar topnavbar">
            ...
            <ul class="navbar-nav flex-row">
               ...
               <li class="nav-item">
                  <a class="nav-link" href="<?=base_url()?>admin/airdrop/logout">
         ...
         <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
                     ...
                     <div class="collapse" id="user-block">
                        <div class="item user-block">
                           ...
                           <div class="user-block-info">
                              ...
                              <span class="user-block-role"><?=$this->session->userdata("admin")->email?></span>
                           </div>
                        </div>
                     </div>
                  </li>
                  ...
                  <li class=" ">
                     <a href="<?=base_url()?>admin/user" title="User Management">
                        <em class="icon-people"></em>
                        <span data-localize="sidebar.nav.USERMANAGEMENT">Management</span>
                     </a>
				  </li>
                  <li class="nav-heading ">
                     <span data-localize="sidebar.heading.HEADER">User Reports</span>
                  </li>
                  <li class=" ">
                     <a href="<?=base_url()?>admin/report" title="User Reports">
                        <em class="icon-rocket"></em>
                        <span data-localize="sidebar.nav.Reports">User Reports</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="<?=base_url()?>admin/access" title="Access History">
                        <em class="icon-clock"></em>
                        <span data-localize="sidebar.nav.History">Access History</span>
                     </a>
				  </li>
                  <li class=" ">
                     <a href="<?=base_url()?>admin/call" title="Call History">
                        <em class="icon-phone"></em>
                        <span data-localize="sidebar.nav.CallHistory">Call History</span>
                     </a>
				  </li>
                  <li class=" ">
                     <a href="<?=base_url()?>admin/payment" title="Call History">
                        <em class="icon-wallet"></em>
                        <span data-localize="sidebar.nav.PaymentHistory">Payment History</span>
                     </a>
				  </li>
                  <li class="nav-heading ">
                     <span data-localize="sidebar.heading.HEADER">Personal Information</span>
                  </li>
				  <li class=" ">
                     <a href="<?=base_url()?>admin/profile" title="Change Password">
					 	<em class="icon-lock"></em>
                        <span data-localize="sidebar.nav.Password">Change Password</span>
                     </a>
                  </li>
               </ul>
               <!-- END sidebar nav-->
