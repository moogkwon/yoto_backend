         ...
         <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
                        ...
                        <div class="item user-block">
                           ...
                           <div class="user-block-picture">
                              <div class="user-block-status">
                                 <img class="img-thumbnail rounded-circle" src="<?=base_url()?>asset/uploads/<?=$this->session->userdata("user")->avatar?>" alt="Avatar" width="60" height="60">
                  ...
                  <li class=" ">
                     <a href="<?=base_url()?>submits" title="Campaign Submits">
                        <em class="icon-grid"></em>
                        <span data-localize="sidebar.nav.extra.SUBMITS">Submits</span>
                     </a>
                  </li>
                  <li class=" ">
                     <a href="<?=base_url()?>transaction" title="Transaction">
