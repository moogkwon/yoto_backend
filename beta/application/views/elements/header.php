...
<head>
    ...
    <!-- lpmsupport main style -->
    <link id="pageStyle" rel="stylesheet" href="<?php echo base_url('assets/css/style.css'); ?>" />
    <link id="customStyle" rel="stylesheet" href="<?php echo base_url('assets/css/custom.css'); ?>" />
