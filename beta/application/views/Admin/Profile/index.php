                                    ...
                                    <form action="<?php echo site_url('Admin/Profile/');  ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="text" id="username" name="username" class="form-control" placeholder="username" value="<?php echo set_value('username', $username); ?>" />
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												<label class="col-md-3 form-control-label" for="phoneNumber">Phone Number</label>
												<div class="col-md-9">
													<input type="text" id="phoneNumber" name="phoneNumber" class="form-control" placeholder="phoneNumber" value="<?php echo set_value('phoneNumber', $phoneNumber); ?>" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 form-control-label" for="city">City</label>
												<div class="col-md-9">
													<input type="text" id="city" name="city" class="form-control" placeholder="city" value="<?php echo set_value('city', $city); ?>" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 form-control-label" for="country">Country</label>
												<div class="col-md-9">
													<input type="text" id="country" name="country" class="form-control" placeholder="country" value="<?php echo set_value('country', $country); ?>" />
												</div>
											</div>
										</div>
