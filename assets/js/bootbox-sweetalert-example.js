...
$('#bootbox-confirm-custom').on('click',function () {
    bootbox.confirm({
...
$('#bootbox-confirm-icon').on('click',function () {
    bootbox.confirm({
...
$('#bootbox-custom-html').on('click',function () {
    var dialog = bootbox.dialog({
...
$('#bootbox-custom-css').on('click',function () {
    bootbox.alert({
...
$('#bootbox-small').on('click',function () {
    bootbox.alert({
...
$('#bootbox-large').on('click',function () {
    bootbox.alert({
