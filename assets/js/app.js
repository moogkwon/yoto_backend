...
$(document).ready(function ($) {
  ...
  $('.mailbox-sidebar-toggler').on('click',function () {
    $('body').toggleClass('mailbox-sidebar-hidden');
    resizeBroadcast();
  });

  $('.calendar-sidebar-toggler').on('click',function () {
    $('body').toggleClass('calendar-sidebar-hidden');
    resizeBroadcast();
  });

  $('.message-sidebar-toggler').on('click',function () {
  ...
  $('.brand-minimizer').on('click',function () {
